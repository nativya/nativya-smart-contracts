...
import "../interfaces/DataRegistryStorage.sol";
import "../interfaces/IDataLiquidityPool.sol";
    ...
    DataRegistryStorage
{
    ...
    // uint256 private datasetId=0;
    IDataLiquidityPool public dataLiquidityPool;
     ...
     * @param ownerAddress                      address of the owner
     */
    function initialize(address trustedForwarderAddress, address ownerAddress, address dataLiquidityPoolAddress) external initializer {
        ...
        dataLiquidityPool = IDataLiquidityPool(dataLiquidityPoolAddress);
    }
    ...
    function addFileWithPermissions(
        ...
        //call registerContribution from dataLiquidityPool to increase contributorsCount of the dataset
        // dataLiquidityPool.registerContribution(fileId, datasetId);
